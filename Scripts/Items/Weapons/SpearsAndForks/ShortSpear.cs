...
namespace Server.Items
{
	...
	public class ShortSpear : BaseSpear
	{
        ...
        public override int AosMinDamage { get { return Convert.ToInt32(10 * (100 + BonusDmg) / 100); } }
        public override int AosMaxDamage { get { return Convert.ToInt32(13 * (100 + BonusDmg) / 100); } }
